...
La idea con éste proyecto era vercómo poder usar de manera más real el uso de Rust, o sea, de que manera se pueden implementar / crear herramientas usando éste lenguaje de programación, más allá del típico ejercicio de ```suma de dos dígitos y que la funcion devuelva un entero```.
